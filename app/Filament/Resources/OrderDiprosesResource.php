...
use App\Filament\Resources\OrderDiprosesResource\Pages;
use pxlrbt\FilamentExcel\Actions\Tables\ExportBulkAction;
use App\Filament\Resources\OrderDiprosesResource\RelationManagers;

class OrderDiprosesResource extends Resource
{
    protected static ?string $model = Order::class;
    protected static ?string $navigationGroup = 'Orders';
    protected static ?string $navigationLabel = 'Order Diproses';
    ...
    {
        return Order::where('status', 'Diproses')->count();
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->query(function () {
                return Order::where('status', 'Diproses')->orderBy('id', 'Asc');
            })
            ->columns([
    ...
    {
        return [
            'index' => Pages\ListOrderDiproses::route('/'),
            'create' => Pages\CreateOrderDiproses::route('/create'),
            'edit' => Pages\EditOrderDiproses::route('/{record}/edit'),
        ];
    }
}
