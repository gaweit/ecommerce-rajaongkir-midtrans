...
use App\Filament\Resources\OrderDiterimaResource\Pages;
use pxlrbt\FilamentExcel\Actions\Tables\ExportBulkAction;
use App\Filament\Resources\OrderDiterimaResource\RelationManagers;

class OrderDiterimaResource extends Resource
{
    protected static ?string $model = Order::class;
    protected static ?string $navigationGroup = 'Orders';
    protected static ?string $navigationLabel = 'Order Diterima';
    ...
    {
        return Order::where('status', 'Diterima')->count();
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->query(function () {
                return Order::where('status', 'Diterima')->orderBy('id', 'Asc');
            })
            ->columns([
    ...
    {
        return [
            'index' => Pages\ListOrderDiterimas::route('/'),
            'create' => Pages\CreateOrderDiterima::route('/create'),
            'edit' => Pages\EditOrderDiterima::route('/{record}/edit'),
        ];
    }
}
